    ...
    <%@page import="com.bookstore.dao.*" %>
        <%@page import="com.bookstore.db.*" %>
            <%@page import="com.bookstore.entity.*" %>
                ...
                <body bgcolor="yellow">
                    <% int q=Integer.parseInt(request.getParameter("qau")); String Book_id=request.getParameter("bid");
                        UserDao dao=new UserDao(jdbcconnection.getConnection()); Books
                        book=dao.getBookDetailsById(Book_id); %>
