            ...
            <%@page import="com.bookstore.entity.*" %>
                ...
                <body bgcolor="yellow">
                    ...
                    <% User user=(User)session.getAttribute("currentUser"); if(user==null){
                        ...
                        <% int quantity=Integer.parseInt(request.getParameter("q")); String
                            address=request.getParameter("address"); String name=request.getParameter("cname"); int
                            mobileno=Integer.parseInt(request.getParameter("no")); UserDao dao=new
                            UserDao(jdbcconnection.getConnection()); Orders o=new
                            Orders(address,mobileno,name,quantity); dao.orderConfirm(o); %>
