            ...
            <%@page import="com.bookstore.entity.*" %>
                ...
                <body bgcolor="yellow">
                    ...
                    <% User user=(User)session.getAttribute("currentUser"); if(user==null){
                        ...
                        <% String Book_id=request.getParameter("bid"); UserDao dao=new
                            UserDao(jdbcconnection.getConnection()); Books book=dao.getBookDetailsById(Book_id); %>
                            ...
                            <form method="post" action="OrderDetails.jsp?bid=<%=book.getBook_id()%>">
                                <center>
                                    ...
                                    <tr>
                                        <td><input type="submit" value="Purchase" /> <input type="submit"
                                                value="Cancel" /></td>
